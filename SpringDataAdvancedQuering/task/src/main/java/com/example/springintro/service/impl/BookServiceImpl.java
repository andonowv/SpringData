...
public class BookServiceImpl implements BookService {
    ...
    @Override
    public List<String> findAllGoldenBookWithLessThan5000copies() {
    ...
    @Override
    public List<String> findAllBookTitlesWithPriceLessThan5AndOrMoreThan40() {
        return bookRepository
    ...
    @Override
    public List<String> findAllBooksThatAreNotReleasedInAGivenYear(int year) {
    ...
    @Override
    public List<String> findAllBooksThatAreReleasedBeforeDate(LocalDate date) {
    ...
    @Override
    public List<String> findBookThatContainsAKey(String input) {
